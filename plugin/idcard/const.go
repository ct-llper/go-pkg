...
/*
	...
	截止2019年12月31日止，我国省级、地级、县级和乡级行政区数量如下：
	一级行政区：省级行政区共34个，包括23个省、5个自治区、4个直辖市、2个特别行政区。
	二级行政区：地级行政区共333个，包括293个地级市、7个地区、30个自治州、3个盟。
	三级行政区：县级行政区共2848个，包括967个市辖区、387个县级市、1323个县、117个自治县、49个旗、3个自治旗、1个林区、1个特区。
	四级行政区：乡级行政区共38724个，包括8515个街道、20988个镇、8102个乡、966个民族乡、153个苏木、1个民族苏木、1个县辖区。

	行政区划代码
	行政区划代码，也称行政代码，它是国家行政机关的识别符号，一般执行两项国家标准：《中华人民共和国行政区划代码》（GB/T2260-2007)和《县以下行政区划代码编制规则》（GB/T10114-2003)。由9位阿拉伯数字组成，相当于机关单位的身份号码。按照国务院《行政区划管理条例》规定，行政区划代码由民政部门确定、发布。该标准对我国县以上行政区划的代码做了规定，用六位阿拉伯数字分层次代表我国的省（自治区、直辖市）、地区（市、州、盟）、县（区、市、旗）的名称。
	县级以上行政区划代码，从左至百右的含义是：
	第一、二位表示省（自治区、直辖市、特别行政区）。
	第三、四位表示市（地区、自治州、盟及国家直辖市所属市辖区和县的汇总码）。其中，01-20，51-70表示省直辖市；21-50表示地区（自治州、盟）。
	第五、六位表示县（市辖区、县级市、旗）。01-18表示市辖区或地区（自治州、盟）辖县级市；21-80表示县（旗）；81-99表示省直辖县级市。
	县以下行政区划代码共有12位数字，分为三段：代码的第一段为6位数字，表示县及县以上的行政区划；第二段为3位数字，表示街道、镇和乡；第三段为3位数字，表示居民委员会和村民委员会。其具体格式为：
	 第一段        第二段     第三段
	□□□□□□------□□□------□□□
